...
def gerar_pdf(nome_arquivo):
    ...
    estilo_cabecalho = ParagraphStyle(name='Cabecalho', fontSize=14, spaceAfter=10)
    ...
    estilo_tabela_1 = TableStyle([('BACKGROUND', (0, 0), (-1, 0), colors.grey), ('TEXTCOLOR', (0, 0), (-1, 0), colors.whitesmoke), ('ALIGN', (0, 0), (-1, -1), 'CENTER'), ('GRID', (0, 0), (-1, -1), 1, colors.black)])
    ...
    elements.append(Spacer(1, 12))
    elements.append(criar_tabela(dados_tabela_2_2, estilo_tabela_2))
    elements.append(Spacer(1, 12))
    ...
    estilo_tabela_3 = TableStyle([('BACKGROUND', (0, 0), (-1, 0), colors.grey), ('TEXTCOLOR', (0, 0), (-1, 0), colors.whitesmoke), ('ALIGN', (0, 0), (-1, -1), 'CENTER'), ('GRID', (0, 0), (-1, -1), 1, colors.black)])
